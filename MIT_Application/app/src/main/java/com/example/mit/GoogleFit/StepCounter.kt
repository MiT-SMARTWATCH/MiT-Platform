...
//
//        fitSignIn(FitActionRequestCode.READ_DATA) //  ----1번
//        checkPermissionsAndRun(FitActionRequestCode.SUBSCRIBE) // ---1번
//
//        /** 주석 가득한거 그냥 버리세요 !
//         * 그리고 fun readData() 함수로 가시면 됩니다.*/
//
//        button1.setOnClickListener { // 버튼 클릭시
//            fitSignIn(FitActionRequestCode.READ_DATA)
//            checkPermissionsAndRun(FitActionRequestCode.SUBSCRIBE)
//        }
//    }
...
//                var text7 : TextView = findViewById(R.id.textView7)
//                //data_list.add(total)
//                text7.text = "오늘 걸음 수 : $total" // total 출력
//                Log.i(TAG, "Total steps: $total")
//
//
//
...
//    }
//
//    private fun connect(context: Context, total : Int){
...
//                        val msg = "{\"Today steps\":$total}"
//                        println("{\"Today steps\":$total}")
//                        println("{\"Today steps\":$num}")
//                        val message = MqttMessage()
//                        message.payload = msg.toByteArray()
